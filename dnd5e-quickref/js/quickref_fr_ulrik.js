function initPerso() {
    ...
    fill_section(data_action_fr_ulrik_heroic, "basic-actions", "Action", "heroic");
    
    fill_section(data_bonusaction_fr_ulrik_class, "basic-bonus-actions", "Action bonus", "class");
    fill_section(data_bonusaction_fr_ulrik_heroic, "basic-bonus-actions", "Action bonus", "heroic");
